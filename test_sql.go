...
func main() {
	db, err := sql.Open("adodb", "Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=test;Data Source=ZG\\SQL2008")
	// db, err := sql.Open("adodb", "Data Source = ZG\\SQL2008;Initial Catalog = myDataBase;User Id=sa;Password=sa;")
